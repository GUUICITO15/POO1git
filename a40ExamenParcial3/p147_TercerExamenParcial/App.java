...
public class App extends JFrame implements ActionListener {
    ...
    JDialog jdlAcercaDe;
    JLabel lblDatos, lblNombre, lblEdad, lblSexo, lbleCivil, lblDescripcion, lblSalario;
    JTextField txtNombre, txtEdad, txtSexo, txteCivil, txtDescripcion, txtSalario;
    JScrollPane spane;
    JTable table;
    ...
    public App() {
        ...
        lblDatos = new JLabel("<html>Programación Oriendada a Objetos I<br>Luis Manuel</html>",JLabel.CENTER);
        ...
        lbleCivil = new JLabel("Estado Civil");
        lbleCivil.setHorizontalAlignment(SwingConstants.RIGHT);
        txteCivil = new JTextField();
        pnlDatos.add(lbleCivil);
        pnlDatos.add(txteCivil);
    ...
    public void mostrarDatos(int ren) {
        ...
        txteCivil.setText(datos.get(ren).getEstadoCivil());
        txtDescripcion.setText(datos.get(ren).getDescripción());
        txtSalario.setText(String.valueOf(datos.get(ren).getSalario()));
    }
    ...
    public void guardarCampos() {
        ...
        est.setEstadoCivil(txteCivil.getText());
        est.setDescripción(txtDescripcion.getText());
        est.setSalario(Double.valueOf(txtSalario.getText()));
        datos.add(est);
        cargarDatos();
    }
